...
//		product.getCategory().
	...
	@Override
	public Page<Product> getAllProductWithCategories(List<String> categories, List<String> colors,
									   List<String> sizes, Integer minPrice, Integer maxPrice,
									   Integer minDiscount, String sort, String stock, Integer pageNumber, Integer pageSize) {

		Pageable pageable = PageRequest.of(pageNumber, pageSize);

		List<Product> products = productRepository.filterProductsWithCategories(categories, minPrice, maxPrice, minDiscount, sort);
